...
struct Scene{
    ...
    void render() {
        ...
        //std::cout<<"render - light 0 : "<<scene_lights[0].m_intensity<<std::endl;
        //std::cout<<"render - light 1 : "<<scene_lights[1].m_intensity<<std::endl;
        ...
        shaderProgramPtr->set ("nb_light", 1);
...
//        std::cout<<"setup - light 0 : "<<scene.scene_lights[0].m_intensity<<std::endl;
//        std::cout<<"setup - light 1 : "<<scene.scene_lights[1].m_intensity<<std::endl;
    }
...
void update (float currentTime) {
    if( ! app_timer_is_stopped ) {
        ...
        Light & light1 = scene.scene_lights[ 1 ];
        light1.m_position = glm::vec3 (-2*cos(app_timer), 2*sin(app_timer), 1.5);
